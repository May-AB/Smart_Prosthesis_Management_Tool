...
Arduino_DataBus *bus =
    new Arduino_ESP32SPI(2 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */,
                         GFX_NOT_DEFINED /* MISO */);
Arduino_GFX *gfx =
    new Arduino_ST7789(bus, -1 /* RST */, 3 /* rotation */, true /* IPS */);
...
lv_event_code_t EVENT_SENSOR_CHANGED_SECC; // Will be initialized dynamically in
                                           // setup() or static initializer
